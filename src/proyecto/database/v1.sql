...
--
-- Host: 127.0.0.1    Database: proyectofincurso
-- ------------------------------------------------------
...
CREATE TABLE `inventory` (
  ...
  PRIMARY KEY (`id`),
  KEY `product_id_inventory_idx` (`product_id`),
  CONSTRAINT `product_id_inventory` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`)
...
CREATE TABLE `order` (
  ...
  CONSTRAINT `table_id` FOREIGN KEY (`table_id`) REFERENCES `table` (`id`)
...
INSERT INTO `order` VALUES (2,2,'2025-01-06 00:00:00','updated'),(3,2,'2025-01-06 00:00:00','new');
...
INSERT INTO `order_state_history` VALUES (2,2,'sended','updated','2025-01-06 16:16:54',1),(3,3,NULL,'new','2025-01-06 16:20:26',1);
...
INSERT INTO `table` VALUES (2,5,4,1,'test');
...
--
-- Dumping routines for database 'proyectofincurso'
--
